<%-- 
    Document   : Lokasiedit
    Created on : May 21, 2020, 4:51:42 PM
    Author     : teguh
--%>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Data Lokasi Tender</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <form class="form-horizontal" id="form1" name="form1" method="post" action="lokasiController?go=lokasi_editsave">
              <div class="box-body">
