<%-- 
    Document   : Lokasiadd
    Created on : May 21, 2020, 4:51:02 PM
    Author     : teguh
--%>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <form class="form-horizontal" id="form1" name="form1" method="post" action="lokasiController?go=lokasi_save">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <span class="input-group-btn">
                         <input class="form-control" name="lokasibangunan"  id="kode" type="text"  size="50" maxlength="25" placeholder="Nama"  value="${lokasibangunan}" required />
